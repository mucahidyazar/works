...
export const selectProductDetailData = state =>
  selectProductDetail(state)?.data[0]
export const selectProductDetailSelected = state =>
  selectProductDetail(state)?.selected
export const selectProductDetailStatus = state =>
  selectProductDetail(state).status
export const selectProductDetailError = state =>
  selectProductDetail(state).error
